...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net USB_UART_TX_1 [get_bd_ports USB_UART_TX] [get_bd_pins core_0/uart_input]
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins clk_wiz/clk_out1] [get_bd_pins core_0/clk]
  connect_bd_net -net clk_wiz_locked [get_bd_pins clk_wiz/locked] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net core_0_uart_output [get_bd_ports USB_UART_RX] [get_bd_pins core_0/uart_output]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz/reset]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins core_0/rst] [get_bd_pins util_vector_logic_0/Res]
